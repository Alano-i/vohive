...
const activeNotifyTab = ref('wecom')
...
<template>
  <div>
    <PageHeader title="通知中心" subtitle="集中管理消息推送渠道与通知模板" />
         ...
         <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 relative z-10">
            <div class="flex items-center gap-3">
               ...
               <div>
                  ...
                  <p class="text-xs text-gray-500">企业微信 / 飞书 / QQ / Telegram / Webhook</p>
               </div>
            </div>
            ...
            <el-tabs v-model="activeNotifyTab" class="settings-notify-tabs">
              ...
              <el-tab-pane label="飞书 Bot" name="feishu" class="pt-2">
                ...
                <div class="space-y-4">
                  ...
                  <div class="notify-config-tip">
                    <strong>配置说明：</strong>
                    <ol class="list-decimal ml-4 mt-1 space-y-1">
                      <li>在<a href="https://open.feishu.cn" target="_blank" class="underline hover:text-emerald-800 dark:hover:text-emerald-200">飞书开放平台</a>创建自建应用，启用「机器人」能力</li>
              ...
              <el-tab-pane label="QQ Bot" name="qq" class="pt-2">
                ...
                <div class="space-y-4">
                  ...
                  <div class="notify-config-tip">
                    <ol class="list-decimal ml-4 mt-1 space-y-1">
                      <li>QQbot申请地址：<a href="https://q.qq.com/qqbot/openclaw/index.html" target="_blank" class="underline hover:text-emerald-800 dark:hover:text-emerald-200">官方控制台</a></li>
...
:global(html.dark .notify-config-tip) {
