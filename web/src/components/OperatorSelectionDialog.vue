      ...
      <div class="bg-gray-50 dark:bg-white/5 rounded-lg p-4 mb-4 border border-gray-100 dark:border-white/5">
        <div class="flex justify-between items-center mb-2">
          ...
          <span class="px-2 py-0.5 rounded text-xs font-medium" 
            :class="currentSelection?.mode === 'automatic' ? 'bg-primary-100 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' : 'bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-300'">
