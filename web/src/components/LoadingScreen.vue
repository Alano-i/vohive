  ...
  <div class="min-h-[260px] w-full flex items-center justify-center">
    <div class="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 dark:bg-white/5 backdrop-blur-xl p-6 shadow-2xl">
      <div class="flex items-center gap-3">
        <div class="w-11 h-11 rounded-2xl bg-gradient-to-br from-[#2557ca] to-[#1947ad] text-white text-sm font-extrabold flex items-center justify-center shadow-lg shadow-blue-700/25">
          VH
        </div>
        <div class="min-w-0">
