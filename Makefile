...
LOCAL_MODULE_DIRS = \
	third_party/euicc-go \
	third_party/uicc-go \
	third_party/netlink \
	third_party/qqbot \
	third_party/quectel-qmi-go \
	third_party/swu-go \
	third_party/vowifi-go
...
build-amd64: check-local-modules frontend-dist
